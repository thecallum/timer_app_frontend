...
export const fetchPlaceholderEvents = (
  currentWeek: number,
): CalendarEvent[] => {
  const weekOffset =
    dayjs()
      .startOf('week')
      .diff(
        dayjs('Mon Jan 08 2024 08:15:00 GMT+0000').startOf('week'),
        'weeks',
      ) + currentWeek
  ...
  return [
    ...
    new CalendarEvent(
      'BBB',
      dayjs('Tue Jan 09 2024 08:50:00 GMT+0000').add(weekOffset, 'week'),
      dayjs('Tue Jan 09 2024 10:20:00 GMT+0000').add(weekOffset, 'week'),
      placeholderProjects[1],
    ),
    new CalendarEvent(
      'CCC',
      dayjs('Tue Jan 09 2024 09:30:00 GMT+0000').add(weekOffset, 'week'),
      dayjs('Tue Jan 09 2024 11:05:00 GMT+0000').add(weekOffset, 'week'),
      placeholderProjects[2],
    ),
    new CalendarEvent(
      'DDD',
