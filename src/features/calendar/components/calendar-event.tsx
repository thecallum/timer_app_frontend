...
export const CalendarEvent = (props: Props) => {
  ...
  return (
    <li className="relative">
      ...
      {/* if we render as generic div (as="div"), we can then pass any children with the desired element, ie li in this case  */}
      <button
        ...
        >
          ...
          <div className="inline-block">
            <div className="flex flex-row justify-start items-center bg-pink-200 p-1 px-2 rounded-md">
              ...
              <div className="ml-2 text-xs text-pink-600 leading-tight">
                Work
              </div>
            </div>
          </div>
